    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "sales-overview/",
                    views.sales_overview_employee,
                    name="sales_overview",
                ),
                path(
                    "inventory-check/",
                    views.inventory_check_employee,
                    name="inventory_check",
                ),
                path(
                    "training-resources/",
                    views.training_resources_employee,
                    name="training_resources",
                ),
                path(
                    "notifications/", views.notifications_employee, name="notifications"
                ),
